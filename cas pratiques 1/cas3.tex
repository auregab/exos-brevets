...
\begin{itemize}
    ...
    pas d'opposition pendant la saisie. Mais, action
    ultérieure en référé-rétractation A497 CPC
    pour constester la saisie.
\end{itemize}
